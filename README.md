...
Initialize the PostgreSQL database and run the migrations to create the necessary tables (including the User table required for login):
...
- **Database**: The app requires a PostgreSQL database to run locally and in production.
